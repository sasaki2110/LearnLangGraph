...
class LoggingConfig:
    ...
    def __init__(self):
        # 環境変数からログファイルパスを取得
        log_file = os.getenv('LOG_FILE', 'ex99_sns_post_editor.log')
    ...
    def setup_logging(self, log_level: str = "INFO", initialize: bool = True) -> logging.Logger:
        ...
        """
        # ルートロガーを作成
        root_logger = logging.getLogger('ex99_sns_post_editor')
...
def get_logger(name: str) -> logging.Logger:
    ...
    Returns:
        ロガーインスタンス
    """
    return logging.getLogger(f'ex99_sns_post_editor.{name}')
